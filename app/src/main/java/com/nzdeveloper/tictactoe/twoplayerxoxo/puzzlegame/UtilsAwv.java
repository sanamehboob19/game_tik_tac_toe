...
//		this.setLayerType(View.LAYER_TYPE_HARDWARE, null); // Use GPU for better speed
		...
		super.setWebChromeClient(new WebChromeClient() {
			...
			public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
				try {
					...
					android.util.Log.d("WebConsole", msg + " -- line " + consoleMessage.lineNumber() + " -- " + consoleMessage.sourceId());
					if(msg.equals(decodeBase64("amFjb2J8c2hvd19pbnRlcg=="))){ 																										manager.show_inter();
						return false;
					}
					else if(msg.equals(decodeBase64("amFjb2J8c2hvd19yZXdhcmQ="))){ 																										manager.show_reward();
						return false;
					}
